...
\leftheader{%
  {\LARGE\bfseries\sffamily David Ponarovsky, PhD student. }

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{David.Ponarovsky@mail.huji.ac.il}}}
  \makefield{\faGithub}
  {\href{https://github.com/dudupo}{\texttt{githhub/dudupo}}}
